...
- `npm run data:generate` — 重新生成文章和五笔码表数据

## Architecture

**框架**: Next.js 16 + Vinext（Vite-based Next.js 运行时），部署目标为 Cloudflare Workers 或 GitHub Pages 静态导出。
...
**PWA**: `public/sw.js` + `public/manifest.webmanifest` 提供离线缓存支持。
