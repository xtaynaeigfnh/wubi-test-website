...
- `app/components/views/` — `TypingView`、`ChallengeView`、`LookupView`、`HistoryView`、`SettingsView` 页面组件；文章测速的码长诊断 Hook 位于 `typing/useTypingDiagnostics.ts`，其余状态与副作用仍整体保留在 `TypingView.tsx`
