...
一个面向 86 版五笔熟练用户的本地打字练习网站，包含 300 篇离线文章、前 1500 常用字分段练习、文章测速、今日训练、错题复练、五码根专项、字码挑战、离线查码、本地成绩、按键使用画像、练习设置，以及可跨页面持续播放的离线 Lo-fi 音乐。
